  ...
  return (
    <Container>
      ...
      <CardDoing>
        ...
        <DoingTitle>{orders?.contract.name}</DoingTitle>
      </CardDoing>
      <CardDoingContainer>
        <OrderMeta>
          <Icon
            ...
            style={{ marginLeft: 8 }}
          />
          <DoingTitle>{orders?.title}</DoingTitle>
        </OrderMeta>
      </CardDoingContainer>
      <CardDoingContainer>
        <OrderMeta>
      ...
      <DoingButton onPress={() => {}}>
        <DoingButtonText>Devolver</DoingButtonText>
      </DoingButton>
      <DoingButton onPress={() => {}}>
        <DoingButtonText>Finalizar</DoingButtonText>
      </DoingButton>
    </Container>
  );
};
